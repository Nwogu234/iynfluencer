...
class ListpostcaptionItemWidget extends StatelessWidget {
  ListpostcaptionItemWidget(
    this.listpostcaptionItemModelObj, {
    Key? key,
  }) : super(
          key: key,
        );

  ListpostcaptionItemModel listpostcaptionItemModelObj;

  var controller = Get.find<InfluencerProfileCommPostController>();
