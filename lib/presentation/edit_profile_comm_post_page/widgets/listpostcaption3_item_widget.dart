...
class Listpostcaption3ItemWidget extends StatelessWidget {
  Listpostcaption3ItemWidget(
    this.listpostcaption3ItemModelObj, {
    Key? key,
  }) : super(
          key: key,
        );

  Listpostcaption3ItemModel listpostcaption3ItemModelObj;

  var controller = Get.find<EditProfileCommPostController>();
