...
import '../models/listgroup853_item_model.dart';
import 'package:flutter/material.dart';
import 'package:iynfluencer/core/app_export.dart';

// ignore: must_be_immutable
class Listgroup853ItemWidget extends StatelessWidget {
  Listgroup853ItemWidget(
    this.listgroup853ItemModelObj, {
    Key? key,
  }) : super(
          key: key,
        );

  Listgroup853ItemModel listgroup853ItemModelObj;

  var controller = Get.find<NotificationLikedPostController>();
          ...
          children: [
            Padding(
              ...
              child: Row(
                children: [
                  CustomImageView(
                    imagePath: ImageConstant.imgGroup85217,
                    height: getSize(
                      40,
                    ),
                    width: getSize(
