...
class MessagesPage1ItemWidget extends StatelessWidget {
  MessagesPage1ItemWidget(
    this.messagesPage1ItemModelObj, {
    Key? key,
  }) : super(
          key: key,
        );

  MessagesPage1ItemModel messagesPage1ItemModelObj;

  var controller = Get.find<MessagesPageOneController>();
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        ...
        children: [
          CustomImageView(
            imagePath: ImageConstant.imgGroup8837,
            height: getSize(
              55,
            ),
            width: getSize(
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                Obx(
                  () => Text(
                    messagesPage1ItemModelObj.senderTxt.value,
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                Obx(
                  () => Text(
                    messagesPage1ItemModelObj.timeTxt.value,
                    overflow: TextOverflow.ellipsis,
                    textAlign: TextAlign.left,
                ...
                CustomTextFormField(
                  ...
                  focusNode: FocusNode(),
                  autofocus: true,
                  controller: messagesPage1ItemModelObj.framethreeController,
                  hintText: "lbl_2".tr,
                  margin: getMargin(
                    left: 2,
                    top: 6,
