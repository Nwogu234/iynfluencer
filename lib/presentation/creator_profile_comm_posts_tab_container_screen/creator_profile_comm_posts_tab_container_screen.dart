...
import 'package:iynfluencer/presentation/creator_profile_comm_posts_page/creator_profile_comm_posts_page.dart';
import 'package:iynfluencer/presentation/edit_profile_comm_post_page/edit_profile_comm_post_page.dart';
import 'package:iynfluencer/widgets/app_bar/appbar_image.dart';
import 'package:iynfluencer/widgets/app_bar/custom_app_bar.dart';
import 'package:iynfluencer/widgets/custom_button.dart';

class CreatorProfileCommPostsTabContainerScreen
    extends GetWidget<CreatorProfileCommPostsTabContainerController> {
  const CreatorProfileCommPostsTabContainerScreen({Key? key}) : super(key: key);
                                    ...
                                    SizedBox(
                                        ...
                                        child: TabBarView(
                                            controller:
                                                controller.tabviewController,
                                            children: [
                                              CreatorProfileCommPostsPage(),
                                              EditProfileCommPostPage(),
                                              EditProfileCommPostPage()
                                            ]))
                                  ])))
                    ]))));
