...
class RequestAcceptedScreen extends GetWidget<RequestAcceptedController> {
  const RequestAcceptedScreen({Key? key})
      : super(
          key: key,
        );
