...
import '../models/listgroup857_item_model.dart';
import 'package:flutter/material.dart';
import 'package:iynfluencer/core/app_export.dart';
import 'package:iynfluencer/widgets/custom_button.dart';

// ignore: must_be_immutable
class Listgroup857ItemWidget extends StatelessWidget {
  Listgroup857ItemWidget(
    this.listgroup857ItemModelObj, {
    Key? key,
  }) : super(
          key: key,
        );

  Listgroup857ItemModel listgroup857ItemModelObj;

  var controller = Get.find<NotificationRequestsController>();
          ...
          children: [
            Padding(
              ...
              child: Row(
                children: [
                  CustomImageView(
                    imagePath: ImageConstant.imgGroup85255,
                    height: getSize(
                      40,
                    ),
                    width: getSize(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Row(
                        children: [
                          CustomImageView(
                            imagePath: ImageConstant.imgGroup85256,
                            height: getSize(
                              28,
                            ),
                            width: getSize(
