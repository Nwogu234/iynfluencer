...
class Listpostcaption2ItemWidget extends StatelessWidget {
  Listpostcaption2ItemWidget(
    this.listpostcaption2ItemModelObj, {
    Key? key,
  }) : super(
          key: key,
        );

  Listpostcaption2ItemModel listpostcaption2ItemModelObj;

  var controller = Get.find<CreatorProfileCommPostsController>();
