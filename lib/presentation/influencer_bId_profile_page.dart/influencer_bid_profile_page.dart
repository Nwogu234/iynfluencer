...
import 'package:iynfluencer/presentation/influencer_profile_about_page/models/chipviewframe89_item_model.dart';
...
class InfluencerBidProfilePage extends StatelessWidget {
  InfluencerBidProfilePage(
      {required this.chatData, required this.selectedInfluencer});

  final Influencers selectedInfluencer;
  ...
  Widget build(BuildContext context) {
    ...
    ChatsOpenedController chatsController = Get.put(ChatsOpenedController(
        chatData: chatData ?? chatsData, selectedInfluencers: selectedInfluencer));

    String? avatarUrl = selectedInfluencer.user?.avatar;
    ...
    0, (sum, social) => sum + (social.followers ?? 0)) ?? 0;
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text(
                    "${capitalizeFirstLetter(selectedInfluencer?.user?.firstName)} ${capitalizeFirstLetter(selectedInfluencer?.user?.lastName)}",
                    overflow: TextOverflow.ellipsis,
                    textAlign: TextAlign.left,
                    style:
                    ...
                    Padding(
                        ...
                        child: Row(children: [
                          ...
                          Padding(
                              ...
                              child: Text(
                                "${capitalizeFirstLetter(selectedInfluencer?.user?.country)}",
                                overflow: TextOverflow.ellipsis,
                                textAlign: TextAlign.left,
                        ...
                        children: [
                          CustomButtonTwo(
                            ...
                            onTap: () => Get.bottomSheet(
                                HireModal(influencers: selectedInfluencer),
                                backgroundColor: ColorConstant.whiteA700),
