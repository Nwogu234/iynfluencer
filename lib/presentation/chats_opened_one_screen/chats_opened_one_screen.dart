...
class ChatsOpenedOneScreen extends GetWidget<ChatsOpenedOneController> {
  const ChatsOpenedOneScreen({Key? key}) : super(key: key);
        ...
        child: Scaffold(
            ...
            appBar: CustomAppBar(
                ...
                title: Padding(
                    ...
                    child: Row(children: [
                      AppbarCircleimage(imagePath: ImageConstant.imgGroup85249),
                      AppbarSubtitle(
