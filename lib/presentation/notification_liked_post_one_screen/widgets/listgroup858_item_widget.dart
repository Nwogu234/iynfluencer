...
import '../models/listgroup858_item_model.dart';
import 'package:flutter/material.dart';
import 'package:iynfluencer/core/app_export.dart';

// ignore: must_be_immutable
class Listgroup858ItemWidget extends StatelessWidget {
  Listgroup858ItemWidget(
    this.listgroup858ItemModelObj, {
    Key? key,
  }) : super(
          key: key,
        );

  Listgroup858ItemModel listgroup858ItemModelObj;
          ...
          children: [
            Padding(
              ...
              child: Row(
                children: [
                  CustomImageView(
                    imagePath: ImageConstant.imgGroup85259,
                    height: getSize(
                      40,
                    ),
                    width: getSize(
