import '../notification_page_influencer_screen/widgets/listgroup859_item_widget.dart';
...
class NotificationPageInfluencerScreen
    extends GetWidget<NotificationPageInfluencerController> {
  const NotificationPageInfluencerScreen({Key? key}) : super(key: key);
                            ...
                            children: [
                              ...
                              Obx(() => ListView.separated(
                                  ...
                                  itemCount: controller
                                      .notificationPageInfluencerModelObj
                                      .value
                                      .listgroup859ItemList
                                      .value
                                      .length,
                                  itemBuilder: (context, index) {
                                    Listgroup859ItemModel model = controller
                                        .notificationPageInfluencerModelObj
                                        .value
                                        .listgroup859ItemList
                                        .value[index];
                                    return Listgroup859ItemWidget(model);
                                  })),
                              SizedBox(
                                  width: double.maxFinite,
                                  child: Container(
